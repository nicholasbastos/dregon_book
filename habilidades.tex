...
% Original: 10xpm,8xpf - média = 9 XP
...
% Original: 10xpm,20ps - média = 15 XP
...
%	\item Esquiva Aprimorada (4xpf,6XP): por 2 PM o usuário recebe um bônus na esquiva igual ao bônus de concentração para todo um turno de esquiva. Habilidade reflexiva. Pré-requisito: Auridade.		
...
% Original: 10ps,10xpf - média = 10 XP
...
% Original: 10ps,6xpf,10xpm - média = 9 XP
...
% Original: 8xpf,10xpm - média = 9 XP
...
% Original: 20ps,10xpm - média = 15 XP
...
% Original: 10ps,8xpf,10xpm - média = 9 XP
...
% Original: 8ps,10xpf,10xpm - média = 9 XP
...
% Original: 10ps,14xpm - média = 12 XP
...
% Original: 8PS,12xpm - média = 10 XP
...
% 	\item Justiça do Anjo(8xpm,8XP): Não somente um dano anterior, mas os dois últimos danos anteriores podem ser acumulados para o calcular o bônus recebido pela habilidade Vingança do anjo caido. Se comprada novamente até os 3 danos anteriores podem ser usados.
 
% Original: 8xpm,8xpf - média = 8 XP
...
% Original: 4xpf,14xpm - média = 9 XP
...
% Original: 8xpf,16xpm - média = 12 XP
...
% Original: 20ps,12xpm - média = 16 XP
...
% Original: 20ps,8xpf,12xpm - média = 13 XP
...
% Original: 20ps,4xpm,12xpf - média = 12 XP
...
% Original: 10PS,10xpf,10xpm - média = 10 XP
...
% Original: 20PS,12xpm,12xpf - média = 15 XP
...
% 	\item Regeneração(20ps,4xpm,12XP): Durante concentração turnos e por 4 PM e 2 PF, o usuário fica com a condição positiva regeneração 5 (recupera 5 PV por turno). Habilidade simples.
...
%	\item Mimetismo(40ps,14xpm,14XP): Sempre que alguem utilizar uma técnica o usuário de mimetismo pode ativa-la reflexivamente Por 12 PM e 4 PF. O usuário dessa magia faz um teste de concentração mais o bônus de observar com dificuldade váriavel (25-35). Em caso de sucesso ele pode utilizar a mesma técnica pelo resto do dia, inclusive magias. O usuário nescessita de nível mental 6 e físico 6 para aprender essa habilidade.
...
%	\item Pureza do Ki(14xpf,14XP): Após concentrar a habilidade, o usuário pode se livrar de qualquer efeito negativo de redução de atributo. Enquanto concentra essa habilidade o usuário não pode realizar mais nenhuma outra ação no seu turno de ataque. Custa 4 PF quando usado em si próprio e o dobro quando usado nos outros.
...
%	\item Meditação(10xpf,10XP): O usuário pode gastar PF(1) para recuperar PV(1) ao meditar. Para cada Pf gasto, 2 minutos de meditação são requeridos. 
