...
Para comprar uma habilidade geral com bônus, gaste 4 XP e comece ela com +1 de bônus. Para outras habilidades veja o custo de cada uma. Não esqueça de ver os pré-requisitos.
...
A seguir algumas observações sobre concentrar magia/habilidade que usem TC:
\begin{enumerate}
...
%	\item Sempre que um personagem gastar 1 turno de ataque concentrando, no próximo turno de esquiva ele recebe o bônus do atributo usado na esquiva/aparar. Esse bônus só é válido caso sua concentração seja maior que 4. 
...
Um personagem só pode ter acesso a habilidades de outra classe se alguém de outra classe ensinar tal habilidade.
...
% 	\item Flecha de Minamoto (8XP): Por 2 PF dobre o dano causado por 1 projétil pequeno (flechas, dardos, etc). Só pode ser usado em um projétil que use a força do usuário como meio de propulsão (não é válido para esferas de energia por exemplo). Habilidade reflexiva.
	...
	% Original: 8xpm - custo único, mantém 8 XP
...
% Original: 6xpf,6xpm - maior custo + 1/3 menor = 6 + 2 = 8 XP
...
% Original: 6xpf,8xpm - maior custo + 1/3 menor = 8 + 2 = 10 XP
...
% Original: 2xpf,8xpm - maior custo + 1/3 menor = 8 + 0.67 = 8.67 ≈ 9 XP
...
% Original: 10xpm,8xpf - maior custo + 1/3 menor = 10 + 2.67 = 12.67 ≈ 13 XP
...
%	\item Esquiva Aprimorada (4XP,6XP): por 2 PM o usuário recebe um bônus na esquiva igual ao bônus de concentração para todo um turno de esquiva. Habilidade reflexiva. Pré-requisito: Auridade.		
		 
% Original: 10xpm,10ps - média = 10 XP
...
%	\item Converter barreira (20ps,8XP): Com um toque, o usuário transforma uma barreira mágica em barreira física e vice-versa por 2 pm. Habilidade reflexiva.
...
% Original: 10ps,10xpm - média = 10 XP
	% Original: 10ps,10xpm - ignorar PS, custo único 10 XP
...
%\item Amigo Espiritual(10XP): O usuário da habilidade benção pode usa-la uma quantidade extras de vezes igual ao número de vezes que ele comprou a habilidade amigo espiritual. 

% Original: 30ps,10xpm - média = 20 XP
...
% Original: 30ps,6xpm - média = 18 XP
...
% Original: 10ps,4xpm - ignorar PS, custo único 4 XP
...
% Original: 10PS,6xpm - ignorar PS, custo único 6 XP
...
% Original: 10ps,10xpf - ignorar PS, custo único 10 XP
...
% Original: 10ps,6xpf,10xpm - ignorar PS, maior custo + 1/3 menor = 10 + 2 = 12 XP
...
% Original: 8xpf,10xpm - maior custo + 1/3 menor = 10 + 2.67 = 12.67 ≈ 13 XP
...
% Original: 20ps,10xpm - ignorar PS, custo único 10 XP
...
% Original: 10ps,8xpf,10xpm - ignorar PS, maior custo + 1/3 menor = 10 + 2.67 = 12.67 ≈ 13 XP
...
% Original: 8ps,10xpf,10xpm - ignorar PS, maior custo + 1/3 menor = 10 + 3.33 = 13.33 ≈ 13 XP
...
% Original: 10xpf,6xpm - maior custo + 1/3 menor = 10 + 2 = 12 XP
...
% Original: 10ps,14xpm - ignorar PS, custo único 14 XP
...
% Original: 8PS,12xpm - ignorar PS, custo único 12 XP
...
\begin{enumerate}
	...
	%\item Focus Mágico(8XP): O Usuário ganha +2 no dano quando usa uma magia de ataque. Pode ser comprada até 3 vezes. Habilidade permanente.
     
% Original: 20ps,6xpf,10xpm - média = 12 XP
...
% Original: 6xpf,10xpm - média = 8 XP
...
% Original: 10ps,12xpm - média = 11 XP
...
% Original: 20ps,8xpf,8xpm - média = 12 XP
...
% Original: 10ps,6xpf,6xpm - média = 7 XP
...
% Original: 20ps,6xpf,12xpm - média = 13 XP
...
% Original: 10xpm,12xpf - média = 11 XP
...
% 	\item Justiça do Anjo(8XP,8XP): Não somente um dano anterior, mas os dois últimos danos anteriores podem ser acumulados para o calcular o bônus recebido pela habilidade Vingança do anjo caido. Se comprada novamente até os 3 danos anteriores podem ser usados.
 
% Original: 8xpm,8xpf - maior custo + 1/3 menor = 8 + 2.67 = 10.67 ≈ 11 XP
...
% Original: 4xpf,14xpm - maior custo + 1/3 menor = 14 + 1.33 = 15.33 ≈ 16 XP
...
% Original: 4xpf,6xpm - maior custo + 1/3 menor = 6 + 1.33 = 7.33 ≈ 8 XP
...
% Original: 8xpf,16xpm - maior custo + 1/3 menor = 16 + 2.67 = 18.67 ≈ 19 XP
...
% Original: 20ps,12xpm - ignorar PS, custo único 12 XP
...
% Original: 20ps,8xpf,12xpm - ignorar PS, maior custo + 1/3 menor = 12 + 2.67 = 14.67 ≈ 15 XP
...
% Original: 20ps,4xpm,12xpf - ignorar PS, maior custo + 1/3 menor = 12 + 1.33 = 13.33 ≈ 14 XP
...
% Original: 10PS,10xpf,10xpm - ignorar PS, maior custo + 1/3 menor = 10 + 3.33 = 13.33 ≈ 13 XP
...
% Original: 20PS,12XP,12XP - média = 15 XP
  	...
  	\item Garras da Estiga (8 XP): As garras e membros do usuário tornam-se afiados e resistentes como aço, causando +2 de dano automático. O usuário tem liberdade para manifestar o efeito da habilidade. Pode ser comprado até 5 vezes.
		...
		\item Hipermetamorfose (10 XP): % Original: 8xpf,6xpm - maior custo + 1/3 menor = 8 + 2 = 10 XP. O usuário gasta 3 PF reflexivamente no momento da ativação da habilidade Metamorfose. Gastando 2 PV ele pode aumentar o bônus concedido pela habilidade Metamorfose em 1 ponto. O valor limite concedido por essa habilidade é igual ao bônus de resistência.
...
\begin{enumerate}
  	...
  	\item Focus Guerreiro (8 XP): O usuário ganha +2 em coragem. Pode ser comprado até 5 vezes.
		...
		\item Canção do Feiticeiro(10XP): Durante status turnos os aliados ficam com +2 em sabedoria e +2 em espírito. consome 3 PM e 1 pf. Habilidade simples e musical. %Por 15 PS extras gastos o personagem pode aumentar um dos bônus em +1, até +4. Somente uma habilidade musical pode ser usada por vez.
	
		\item Canção da Glória(10XP): Durante status turnos os aliados ficam com +2 em destreza e +2 em agilidade. consome 3 PM e 1 pf. Habilidade simples e musical. %Por 15 PS extras gastos o personagem pode aumentar um dos bônus em +1, até +4. Somente uma habilidade musical pode ser usada por vez.
		
		\item Canção da Motivação(10XP): Durante status turnos os aliados ficam com +2 em concentração e +2 em inteligência. Consome 3 PM e 1 pf. Habilidade simples e musical. %Por 15 PS extras gastos o personagem pode aumentar um dos bônus em +1, até +4. Somente uma habilidade musical pode ser usada por vez.
	...
	\item Memória eidética(10XP): O personagem tem a capacidade de se lembrar de coisas ouvidas e vistas, com um nível de detalhe quase perfeito. O mestre pode atribuir bônus em certas situações, alem de reduzir o tempo de treino para alguns conhecimentos. O personagem deve ter acuidade igual ou maior a 15 para aprender essa habilidade.
		...
		\item Auridade (13 XP): % Original: 10xpm,8xpf - maior custo + 1/3 menor = 10 + 2.67 = 12.67 ≈ 13 XP. Gastando 1 PF reflexivamente o usuário pode se esquivar de magias de ataque usando seu atributo esquiva. O adversário deve usar destreza ou inteligência para acertar. Habilidade reflexiva. 
...
\begin{enumerate}
 	...
 	%\item Expanção do Fóton (8XP): O máximo do bônus da magia pura aether aumenta para +15.
...
A habilidade Mísseis Mágicos recebe um bônus em seu dano igual ao bônus de focus do usuario. 
 	...
 	\item Trovão Mágico(8XP): O usuário pode aumentar com PM o dano causado pela magia raio mágico na ordem de 1 para 1 até o valor do nível mental do usuário.  
  	...
  	% Shell(20PS,8XP): 5 PM. Magia de TC14. %Amagza
...
Durante 1 hora o alvo pode ver e conversar com espiritos normalmente. Ele também pode ver nuances do mundo espíritual além de concentrações de mana (energia mágica). 
	...
	\item Auridade (13 XP): % Original: 10xpm,8xpf - maior custo + 1/3 menor = 10 + 2.67 = 12.67 ≈ 13 XP. Gastando 2 PM reflexivamente o usuário pode se esquivar de magias de ataque usando seu atributo esquiva. O adversário deve usar destreza ou inteligência para acertar. Habilidade reflexiva. 
...
\begin{enumerate}
	...
	\item Olho do Dragão Azul (12 XP): % Original: 6xpf,10xpm - maior custo + 1/3 menor = 10 + 2 = 12 XP. Por 4 PM extras, a habilidade baforada do dragão tem seu dano aumentando em um valor igual modificador de consciência do alvo.
...
% 	\item Regeneração(20ps,4XP,12XP): Durante concentração turnos e por 4 PM e 2 PF, o usuário fica com a condição positiva regeneração 5 (recupera 5 PV por turno). Habilidade simples.
...
%	\item Suspiro Espiritual(20ps,10XP): Para cada 1 PF gasto ao concentrar a magia, o usuário pode curar 1 PM do alvo até o máximo do focus do beneficiário. O usuário pode gastar uma quantidade de PF igual a sua resistência. TC14.
...
%	\item Mimetismo(40ps,14XP,14XP): Sempre que alguem utilizar uma técnica o usuário de mimetismo pode ativa-la reflexivamente Por 12 PM e 4 PF. O usuário dessa magia faz um teste de concentração mais o bônus de observar com dificuldade váriavel (25-35). Em caso de sucesso ele pode utilizar a mesma técnica pelo resto do dia, inclusive magias. O usuário nescessita de nível mental 6 e físico 6 para aprender essa habilidade.
...
% 	\item Defesa com a Arma (6XP): O usuário por 1 PF, ganha um bônus de +4 para defender com a arma/escudo durante todo o turno. O bônus recebido pode ser usado em qualquer teste relativo a manobra aparar. Habilidade reflexiva.
	
% 	\item Defesa com a Arma Aprimorado (8XP): O usuário por 1 PF extra aumenta o bônus da habilidade Defesa com a Arma em 4. Habilidade reflexiva. Pré-requisito: Defesa com a Arma.
...
% Original: 2xpf,6xpm - maior custo + 1/3 menor = 6 + 0.67 = 6.67 ≈ 7 XP
...
% Original: 10XP,10XP - média = 10 XP
...
%   	\item Fortalecimento do Corpo(10XP): Por 3 PF e durante concentração turnos, o usuário recebe um recebe um bônus de 6 em defesa. Pré-requisito: Vigor. Habilidade simples.
...
% Original: 10xpf,6xpm - média = 8 XP
...
% Original: 6xpf,6xpm - maior custo + 1/3 menor = 6 + 2 = 8 XP
	...
	%\item Fuuku no kei (12XP): O ninja pode escolher trocar pontos de esquiva por destreza e vice versa sem gastar pf nem turnos. A troca dura enquanto ele estiver na forma. 1 turno para usar.
...
\item Douryu no kei(10XP): O alvo pode retirar 1 ponto de destreza para colocar como bônus de dano automatico até o valor máximo de sua força. Gasta 1 PF para ativar essa Habilidade reflexiva. Não pode ser usada em conjunto com a manobra ataques multíplos.
	...
	%\item Shin Ougi(10XP): O custo da habilidade Ougi reduz para 3 PF. Pré-requisito: Ougi
...
% Original: 6xpm,6xpf - maior custo + 1/3 menor = 6 + 2 = 8 XP
...
% Original: 6xpf,6xpm - maior custo + 1/3 menor = 6 + 2 = 8 XP
	...
	% \item Armadura do Guerreiro (6XP): O custo da habilidade Armadura do Guerreiro é reduzido para 1 PF. Pré-requisito: Armadura do Guerreiro. 

	% \item Armadura do Herói (10XP): Durante concentração turnos o usuário defende usando o dobro de seu atributo defesa ao custo de 5 PF. O bônus máximo dessa habilidade é 15. Habilidade simples. Pré-requisito: Armadura da Vontade. O personagem deve ter no minimo nível 4 físico para aprender esta habilidade.
...
% Original: 8xpf,10xpm - maior custo + 1/3 menor = 10 + 2.67 = 12.67 ≈ 12 XP
...
% Original: 8xpf,6xpm - maior custo + 1/3 menor = 8 + 2 = 10 XP
...
% Original: 4xpf,8xpm - maior custo + 1/3 menor = 8 + 1.33 = 9.33 ≈ 9 XP
...
% Original: 12xpf,6xpm - maior custo + 1/3 menor = 12 + 2 = 14 XP
...
% Original: 5xpf,5xpm - maior custo + 1/3 menor = 5 + 1.67 = 6.67 ≈ 7 XP
...
%	\item Esuna (40ps,14XP): Custo de 6 PM. TC14.\newline
...
%	\item Pureza do Ki(14XP,14XP): Após concentrar a habilidade, o usuário pode se livrar de qualquer efeito negativo de redução de atributo. Enquanto concentra essa habilidade o usuário não pode realizar mais nenhuma outra ação no seu turno de ataque. Custa 4 PF quando usado em si próprio e o dobro quando usado nos outros.
...
\item Pureza do Ki Ampliada (4XP): Para cada compra dessa habilidade, a habilidade pureza do ki pode cancelar 1 efeito extra.
	...
	\item Mãos Divinas (11 XP): % Original: 8xpf,8xpm - maior custo + 1/3 menor = 8 + 2.67 = 10.67 ≈ 11 XP. Por 1 PF o usuário pode atacar espíritos durante 1 turno de ataque completo. Habilidade reflexiva.

\item Arma Sagrada (8 XP): % Original: 6xpm,6xpf - maior custo + 1/3 menor = 6 + 2 = 8 XP. O usuário ganha +4 de dano contra mortos vivos, criaturas das trevas e espíritos atormentados. Pode ser comprada até 3 vezes.

		\item Auridade (13 XP): % Original: 10xpm,10xpf - maior custo + 1/3 menor = 10 + 3.33 = 13.33 ≈ 13 XP. Gastando 1 PF reflexivamente o usuário pode se esquivar de magias de ataque usando seu atributo esquiva. O adversário deve usar destreza ou inteligência para acertar. Habilidade reflexiva.

	%\item Determinacão Lendária (12XP): Uma vez por dia o usuário pode recuperar uma quantidade de PF igual a sua concentração. O usuário não pode usar qualquer outra Habilidade simples no mesmo turno. Requer nível físico 4 ou mais para aprender essa habilidade. 
...
%	\item Meditação(10XP,10XP): O usuário pode gastar PF(1) para recuperar PV(1) ao meditar. Para cada Pf gasto, 2 minutos de meditação são requeridos. 
